        ...
        <div class="home">
            <div class="main_page">
                <div class="header_title">
                    ...
                    <a href="/healthtea/listingproductpage.php">
            ...
            <div class="product_box">
                <div class="item">
                    ...
                    <p></p>
                    <a href="/healthtea/itemdetailpage.php?id=8">
                ...
                <div class="item">
                    ...
                    <p></p>
                    <a href="/healthtea/itemdetailpage.php?id=4">
                    <button class="white_button">More details</button>
                    </a>
                </div>
                <div class="item">
                    ...
                    <p></p>
                    <a href="/healthtea/itemdetailpage.php?id=7">
                    <button class="white_button">More details</button>
                    </a>
                </div>
            </div>
            <div class="new_product_page">
                ...
                <div>
                    <div class="new_product_list">
                        <a href="/healthtea/itemdetailpage.php?id=2">
                        <div>
                    ...
                    <div class="new_product_list">
                        <a href="/healthtea/itemdetailpage.php?id=3">
                        <div>
                    ...
                    <div class="new_product_list">
                        <a href="/healthtea/itemdetailpage.php?id=1">
                        <div>
            ...
            <div class="hot_product_page">
                ...
                <div class="hot_product_menu">
                    <div class="item">
                    <a href="/healthtea/itemdetailpage.php?id=5">
                        <div>
                    ...
                    <div class="item">
                    <a href="/healthtea/itemdetailpage.php?id=6">
                        <div>
                    ...
                    <div class="item">
                    <a href="/healthtea/itemdetailpage.php?id=9">
                        <div>
                    ...
                    <div class="item">
                    <a href="/healthtea/itemdetailpage.php?id=10">
                        <div>
