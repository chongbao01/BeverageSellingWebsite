...
<body>
    ...
    <?php 
        ...
        if(isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1){
			echo "<button onclick=\"location.href='editdelete.php?add=addnewproduct'\" class=\"add_button\"'>Add new product</button>";
        }
        // Execute query
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            while ($row = mysqli_fetch_assoc($result)){
                ...
                if(isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1){
                    echo "<td><a href='editdelete.php?edit=editproduct&prod_id={$row['prod_id']}' class=\"edit_button\"'>Edit product</a></td>";
                    echo "<td><a href='editdelete.php?delete=deleteproduct&prod_id={$row['prod_id']}&name={$row["prod_name"]}' 
        ...
        if(isset($_SESSION['is_admin']) && $_SESSION['is_admin'] == 1){
            ...
            if(mysqli_num_rows($result1) > 0){
                ...
                while ($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    echo "<td><a href='editdelete.php?edit=editproduct&prod_id={$row1['prod_id']}' style='color:purple; text-decoration:underline;'>Edit product</a></td>";
                    echo "<td><a href='editdelete.php?show=showproduct&prod_id={$row1['prod_id']}&name={$row1["prod_name"]}' style='color:green; text-decoration:underline;'>Show product</a></td>";
                    echo "</tr>";
                };
                echo "</table>";
            };
